class Http {
    constructor() {
        ...
        // Nếu this.refreshTokenRequest đã tồn tại (nghĩa là đang có 1 request refresh token chạy) → tái sử dụng Promise đó, tránh gọi nhiều lần refresh trùng lặp.

        // Nếu chưa có → gọi refreshToken() để xin access token mới.

        // Dùng .finally() để reset this.refreshTokenRequest về null khi xong.
