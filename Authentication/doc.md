...
Authentication là việc xác thực danh tính người dùng. Ví dụ bạn vào page abc.com/admin để quản trị trang web của bạn thì cần bạn nói cho server biết là ai.

Bản chất của authentication vẫn là 
- Tạo ra một dấu hiệu gì để server biết bạn
- Lưu trữ dấu hiệu này ở đâu
- Thực hành kiếm tra dấu hiệu này như thế nào
