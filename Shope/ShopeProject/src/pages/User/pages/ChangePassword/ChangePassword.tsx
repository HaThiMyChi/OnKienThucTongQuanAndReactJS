...
import type { ErrorResponse, NoUndefinedField } from '../../../../types/utils.type'
import { ObjectSchema } from 'yup'

// chạy ở TypeScript / lúc code -> định nghĩa kiểu dữ liệu form
type FormData = NoUndefinedField<Pick<UserSchema, 'password' | 'new_password' | 'confirm_password'>>
// Runtime / lúc app chạy -> Validate dữ liệu form
