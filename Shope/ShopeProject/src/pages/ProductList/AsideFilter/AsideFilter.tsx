    ...
    <div className='py-4'>
            ...
            <li className='py-2 pl-2' key={categoryItem._id}>
              <Link
                to={{
                  pathname: path.home,
                  search: createSearchParams({
                    ...queryConfig, // Giữ các filter cũ (như page, sort)
                    category: categoryItem._id // Thêm ID của category vừa chọn vào URL
                  }).toString()
                }}
      ...
      <div className='my-5'>
        ...
        <form className='mt-2' onSubmit={onSubmit}>
          ...
          <div className='mt-1 min-h-[1.25rem] text_center text-sm text-red-600'>{errors.price_min?.message}</div>
