...
export default function SortProductList({ queryConfig, pageSize }: Props) {
  ...
  // <ProductListConfig['sort_by'] lấy type của filed sort_by nó tương dương với 'createdAt' | 'view' | 'sold' | 'price' | undefined
  // Exclude<ProductListConfig['sort_by'], undefined> nghĩa là loại bỏ undefined ra khỏi type
    ...
    <div className='bg-gray-300/40 px-3 py-4'>
      <div className='flex flex-wrap items-center justify-center gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <select
            className={classNames('h-8 px-4 tebxt-left text-sm capitalize outline-none ', {
