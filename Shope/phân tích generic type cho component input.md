...
## Lý thuyết về Generic type

Generic type trong TypeScript là cách viết kiểu dữ liệu linh hoạt, cho phép mình tạo function, interface, type, class dùng được với nhiều kiểu khác nhau mà vẫn giữ được type safety (loại an toàn)

Hiểu đơn giản:
Generic giống như “biến đại diện cho kiểu dữ liệu”.

Example: Ý nghĩa <T> là một kiểu tạm thời
...
const result2 = getValue<number>(100);
```
...
=> T không đại diện cho cả array, mà đại diện cho kiểu của từng phần từ trong array

items: T[]
=> T[] nghĩa là items là một mảng, và mỗi phần tử trong mảng có kiểu T

Nếu bạn muốn T là cả array, thì phải viết khác:
...
-> Vì ở đây T nhận nguyên kiểu của [1, 2, 3], tức là number[].
