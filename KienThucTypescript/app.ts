...
// Dùng enum khi có giá trị cố định (role, status).

// Dùng interface khi mô tả object/class để tái sử dụng.

// Dùng type khi cần alias kiểu dữ liệu, union/intersection hoặc tuỳ biến.